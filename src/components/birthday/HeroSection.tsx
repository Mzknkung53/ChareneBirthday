...
import { runBirthdayCelebration } from '@/utils/birthdayCelebration';
...
export function HeroSection() {
  ...
  const celebrate = useCallback((replay = false) => {
    ...
    void runBirthdayCelebration().then((stop) => {
